    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-4 flex gap-0">
          {(["overview", "licenses", "generate", "tutorials", "sounds"] as View[]).map((v) => (
            <button
              key={v}
              onClick={() => setView(v)}
            ...
            >
              {v === "overview" ? "Overview" : v === "licenses" ? "Lisensi" : v === "tutorials" ? "Tutorial" : v === "sounds" ? "Notifikasi" : "Generate"}
            </button>
          ))}
        </div>
      </div>
